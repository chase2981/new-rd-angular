The blocked-appt-time module is used primarily to re-use the day-of-week hours, blocked-appt-time stuff across projects

### Simple @rd/blocked-appt-time module
