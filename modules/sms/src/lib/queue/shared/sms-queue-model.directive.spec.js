...
var sms_queue_model_directive_1 = require("./sms-queue-model.directive");
var sms_module_1 = require("../../sms.module");
describe('Directive: SmsQueueModel', function () {
    var component;
    var debugElem;
    var directive;
    var fixture;
    ...
    it('should create SmsQueueModelDirective', function () {
...
__decorate([
    core_1.ViewChild(sms_queue_model_directive_1.SmsQueueModelDirective),
    __metadata("design:type", sms_queue_model_directive_1.SmsQueueModelDirective)
...
//# sourceMappingURL=sms-queue-model.directive.spec.js.map